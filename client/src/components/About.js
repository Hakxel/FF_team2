        ...
        <div>
          <div className='About-Main'>
           ...
           <div className='bio'>
             ...
             < a href="https://en.wikipedia.org/wiki/Virtual_currency"
            ...
            <h1 id='creators'>Creators</h1>
                ...
                <div className='bio-container'>
                    ...
                    <div className='bio'>
                      <p>Asiel Montes is a full-stack web developer familiar with HTML, CSS, JavaScript, GIT, React, Express, Ruby and Rails. Asiel has experience working in the travel/tourism industry as well as in the financial sector. Asiel holds a Bachelor's degree in Translation. His communication skills are excellent and spoken languages include fluency in Spanish, English and French.
                       <a href="http://www.linkedin.com/in/asiel-montes-27b95612a" target="_blank" rel="noopener noreferrer"> Connect with Asiel.</a></p>
                    </div>
                ...
                <div className='bio-container'>
                    ...
                    <div className='bio'>
                      ...
                      <a href="http://www.linkedin.com/in/alvaro-vargas-910" target="_blank" rel="noopener noreferrer"> Connect with Alvaro.</a></p>
                    </div>
                ...
                <div className='bio-container'>
                    ...
                    <div className='bio'>
                      ...
                      <a href="http://www.linkedin.com/in/jamieldamon" target="_blank" rel="noopener noreferrer"> Connect with Jamie.</a></p>
                    </div>
